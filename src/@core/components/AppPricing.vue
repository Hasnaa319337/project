...
<template>
  ...
  <div class="text-center">
    ...
    <p class="text-sm mb-0">Choose the best plan to fit your needs.</p>
  </div>
  ...
  <div class="d-flex align-center justify-center mx-auto py-10">
    ...
    <div class="position-relative">
      <div class="position-absolute price-chip d-none d-sm-flex">
        ...
        <VChip text="Save up to 10%" size="small" color="primary" />
      </div>
    ...
    >
      ...
      >
        ...
        <VCardText class="text-center px-6 pb-6">
          <VImg :height="100" :src="plan.logo" class="mx-auto mb-5" />
