...
<template>
  ...
  >
    <VCard class="pa-5 pa-sm-8">
      <!-- 👉 dialog close btn -->
      <DialogCloseBtn variant="text" size="small" @click="resetAuthCode" />
      ...
      <VCardText class="pt-6">
        <h6 class="text-h6 font-weight-medium mb-3">Authenticator Apps</h6>
        ...
        <div class="my-6">
          <VImg width="122" :src="pixinventQr" class="mx-auto" />
        </div>
        ...
        <VForm @submit.prevent="() => {}">
          ...
          <div class="d-flex justify-end flex-wrap gap-3">
            ...
            <VBtn type="submit" @click="formSubmit">
              Continue
              <VIcon end icon="mdi-chevron-right" class="flip-in-rtl" />
            </VBtn>
          </div>
        </VForm>
      </VCardText>
