...
<template>
  ...
  >
    <VCard class="share-project-dialog pa-5 pa-sm-8">
      ...
      <VCardText>
        <h5 class="text-h5 text-center mb-2">Share Project</h5>
        <p class="text-sm-body-1 text-center">
          Share project with a team members
        </p>

        <p class="text-xl font-weight-medium mb-2">Add Members</p>
        <VAutocomplete
          :items="membersList"
          item-title="name"
          item-value="name"
        ...
        <div
          class="d-flex justify-space-between align-center flex-wrap gap-3 mt-4"
        >
          ...
          <VBtn variant="text" prepend-icon="mdi-link">
            Copy Project Link
          </VBtn>
        </div>
      </VCardText>
