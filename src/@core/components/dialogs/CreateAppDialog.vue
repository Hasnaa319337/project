        ...
        <VRow>
          ...
          <VCol cols="12" sm="7" md="8" lg="9">
            ...
            >
              <!-- 👉 category -->
              <VWindowItem>
                <VTextField label="Application Name" placeholder="My App" />
              ...
              <!-- 👉 Database Engine -->
              <VWindowItem>
                <VTextField label="Database Name" placeholder="Database Name" />
              ...
              <VWindowItem class="text-center">
                ...
                <VImg :src="illustrationJohn" width="250" class="mx-auto" />
              </VWindowItem>
            </VWindow>
