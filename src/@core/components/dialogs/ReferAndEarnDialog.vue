...
<template>
  ...
  >
    <VCard class="refer-and-earn-dialog">
      ...
      <VCardText class="pa-5 pa-sm-10">
        ...
        <VRow class="text-center mt-6">
          <VCol
            ...
            sm="4"
          >
            <VAvatar variant="tonal" size="100" color="primary">
      ...
      <VCardText class="pa-5 pa-sm-10">
        <h6 class="text-h6 mb-4">Invite your friends</h6>
        ...
        <VForm class="d-flex align-center gap-4" @submit.prevent="() => {}">
          <VTextField density="compact" placeholder="johnDoe@gmail.com" />

          <VBtn type="submit"> Submit </VBtn>
        </VForm>

        <h6 class="text-h6 mb-4 mt-8">Share the referral link</h6>
        ...
        >
          ...
          <div class="d-flex gap-3">
            <VBtn icon class="rounded" color="#3B5998" size="40">
              <VIcon color="white" icon="mdi-facebook" />
            </VBtn>

            <VBtn icon class="rounded" color="#55ACEE" size="40">
              <VIcon color="white" icon="mdi-twitter" />
            </VBtn>

            <VBtn icon class="rounded" color="#007BB6" size="40">
              <VIcon color="white" icon="mdi-linkedin" />
            </VBtn>
          </div>
        </VForm>
      </VCardText>
