...
export const { themeConfig, layoutConfig } = defineThemeConfig({
  app: {
    ...
    logo: h('div', {
      // innerHTML: localStorage.getItem('whatsapploxa-initial-loader-bg') === '#FFFFFF' ? logo : logoDark,
      innerHTML: logo,
      style:
        'width:80px;height:40px; line-height:0; color: rgb(var(--v-global-theme-primary));',
    }),
