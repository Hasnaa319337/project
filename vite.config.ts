...
import ModuleHelper from './src/@core/helpers/ModuleHelper'
...
export default defineConfig({
  plugins: [
    ...
    VueI18nPlugin({
      ...
      include: [
        fileURLToPath(
          new URL('./src/@core/plugins/i18n/locales/**', import.meta.url)
        ),
      ],
    }),
  ],
  ...
  resolve: {
    alias: {
      ...
      '@themeConfig': fileURLToPath(
        new URL('./src/@core/config/themeConfig.ts', import.meta.url)
      ),
      ...
      '@axios': fileURLToPath(
        new URL('./src/@core/plugins/axios', import.meta.url)
      ),
      '@socket': fileURLToPath(
        new URL('./src/@core/plugins/socket', import.meta.url)
      ),
      '@api-service': fileURLToPath(
        new URL('./src/@core/services/ApiService', import.meta.url)
      ),
